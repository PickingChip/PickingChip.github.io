...
<img src=".\Picture\树莓派型号参数.png" alt="树莓派型号参数"  />
...
<img src=".\Picture\树莓派镜像烧录1.png" alt="树莓派镜像烧录1"  />

按NEXT之后，点击编辑设置，设置主机名，密码，和WIFI（不要用校园网，可以连热点或者实验室的路由器）

<img src=".\Picture\树莓派镜像烧录2.png" alt="树莓派镜像烧录2"  />
...
<img src=".\Picture\ip查询.PNG" alt="ip查询"  />
...
<img src=".\Picture\PuTTY连接.PNG" alt="PuTTY连接"  />
...
<img src=".\Picture\powershell连接.PNG" alt="powershell连接"  />
...
<img src=".\Picture\Vnc连接.PNG" alt="Vnc连接"  />
...
<img src=".\Picture\minicom操作2.png" alt="minicom操作2" style="zoom:50%;" />
